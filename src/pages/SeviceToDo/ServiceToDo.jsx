...
const axiosCommon = useAxiosCommon()
  ...
  const { data: toDoData, isLoading } = useQuery({
    queryKey: ['tododata',email],
    queryFn: async () => {
      const { data } = await axiosCommon.get(`/services/service/booked-service/too-service/${email}`);
      return data;
    },
  });
...
const handleSort =async(id,e)=>{
  ...
  return (
      <>
      {
        toDoData?  <div className=" max-w-7xl w-[95%] mx-auto my-16">
